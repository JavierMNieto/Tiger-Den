...
class CheckoutConfig(apps.CheckoutConfig):
    ...
    def ready(self):
        ...
        self.supervisor_info_view = get_class(
            'checkout.views', 'SupervisorView')
        self.delivery_info_view = get_class('checkout.views', 'LocationView')
        self.requests_info_view = get_class(
            'checkout.views', 'OrderRequestsView')
    ...
    def get_urls(self):
        urls = [
            ...
            # Guest Views
            url(r'supervisor-info/$', self.supervisor_info_view.as_view(),
                name='supervisor-info'),

            # Supervisor Views
            url(r'order-requests/$', self.requests_info_view.as_view(),
                name='order-requests'),
            url(r'delivery-info/$', self.delivery_info_view.as_view(),
                name='delivery-info'),
            ...
            # Payment views
            url(r'payment-method/$', self.payment_method_view.as_view(),
                name='payment-method'),
            url(r'payment-details/$', self.payment_details_view.as_view(),
