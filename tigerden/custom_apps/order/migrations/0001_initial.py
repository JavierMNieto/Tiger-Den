# Generated by Django 2.2.11 on 2020-03-09 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_placed', models.DateTimeField(db_index=True)),
                ('total_credit', models.DecimalField(decimal_places=2, default=None, max_digits=12, null=True, verbose_name='Credit Used')),
                ('max_alloc_credit', models.DecimalField(decimal_places=2, default=None, max_digits=12, null=True, verbose_name='Max Amount of Credit Allowed to Use')),
                ...
                ('group_order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='order.GroupOrder', verbose_name='Group Order')),
            ],
            options={
                'verbose_name': 'Order',
